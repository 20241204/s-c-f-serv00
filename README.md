...
![Watchers](https://img.shields.io/github/watchers/20241204/s-c-f-serv00) ![Stars](https://img.shields.io/github/stars/20241204/s-c-f-serv00) ![Forks](https://img.shields.io/github/forks/20241204/s-c-f-serv00) ![Vistors](https://visitor-badge.laobi.icu/badge?page_id=20241204.s-c-f-serv00) ![LICENSE](https://img.shields.io/badge/license-CC%20BY--SA%204.0-green.svg)
<a href="https://star-history.com/#20241204/s-c-f-serv00&Date">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=20241204/s-c-f-serv00&type=Date&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=20241204/s-c-f-serv00&type=Date" />
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=20241204/s-c-f-serv00&type=Date" />
  </picture>
</a>  
# 下载本脚本到 serv00 服务器
    ...
    wget -t 3 -T 10 --verbose --show-progress=on --progress=bar --no-check-certificate --hsts-file=/tmp/wget-hsts -c \
                          "https://raw.githubusercontent.com/20241204/s-c-f-serv00/master/s-c-f-serv00.sh" \
...
# serv00 保活，防止3个月回收
    ...
    # serv00 保活脚本
    cat <<20241204 | tee ${HOME}/auto_ssh.sh
    #!/bin/bash
    ...
    # 写入 crontab 
    cat <<20241204 | tee ${HOME}/crontab >/dev/null
...
# 新增 
1. sing-box 1.11 版本配服务器和客户端更新，1.11 版本废弃了 geoip geosite rule dns 和 outbounds 的部分配置，不过还好改的地方不是很多
...
sing-box's migration : [https://sing-box.sagernet.org/migration/](https://sing-box.sagernet.org/migration/)  
...
robvanoostenrijk's Unofficial FreeBSD cloudflared builds : [https://github.com/robvanoostenrijk/cloudflared-freebsd](https://github.com/robvanoostenrijk/cloudflared-freebsd)  
